...
export default function BlogShellClient({ post }: { post: BlogPost }) {
    ...
    useEffect(() => {
        if (typeof window !== 'undefined') {
            ...
            headings.forEach((heading, index) => {
                ...
                newToc.push({ id, text });
                // We don't mutate the HTML string here easily, 
                // so we rely on the user to add ids in the rich text editor or we just use it for visual display.
            });
    ...
    const faqs = [
        ...
        {
            q: "Why is hiring a marketing agency important in 2026?",
            a: "In 2026, algorithms change daily. A local agency like DigitalRise stays ahead of trends, ensuring your business stays visible. We bring a strategic approach that freelancers often lack, focusing on measurable ROI for your local business."
        },
        {
            ...
            <main className="relative min-h-screen bg-dr-navy text-white overflow-hidden">
                ...
                <section className="relative pt-48 pb-24 px-6 z-10">
                    <div className="max-w-6xl mx-auto text-center">
                        ...
                        >
                            <span className="uppercase">{restOfTitle}</span> <br />
                            <span className="text-gradient-gold bg-clip-text text-transparent bg-gradient-to-r from-dr-gold via-white to-dr-gold animate-shine uppercase">{lastWord}</span>
                        </motion.h1>
                        ...
                        >
                            <div className="flex items-center gap-2 text-[10px] font-black tracking-widest text-dr-text/40 uppercase">
                                <Calendar size={14} className="text-dr-gold" /> {post.date || 'March 1, 2026'}
                            </div>
                            <div className="w-1 h-1 rounded-full bg-dr-text/20" />
                            <div className="flex items-center gap-2 text-[10px] font-black tracking-widest text-dr-text/40 uppercase">
                                <Clock size={14} className="text-dr-gold" /> {post.readTime || '5 MIN READ'}
                            </div>
                            <div className="w-1 h-1 rounded-full bg-dr-text/20" />
                        ...
                        {post.image && (
                            <motion.div 
                                ...
                                className="max-w-4xl mx-auto mt-12 relative aspect-video rounded-3xl overflow-hidden shadow-2xl border border-white/10"
                            >
                ...
                <section className="relative py-24 px-6 z-10 overflow-visible">
                    <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-20">
                        ...
                        <aside className="lg:col-span-4 hidden lg:block sticky top-32 h-fit space-y-12">
                            ...
                            >
                                ...
                                <ul className="space-y-6">
                                    {toc.map((item, i) => (
                                        <li key={i}>
                                            <a href={`#${item.id}`} className="text-sm font-bold text-dr-text/40 hover:text-dr-gold transition-colors flex items-center gap-3 group">
                            ...
                            >
                                ...
                                <p className="text-xs text-white/40 leading-relaxed mb-8 relative z-10">We build bespoke growth systems for forward-thinking brands that scale.</p>
                            ...
                            >
                                ...
                                <div>
                                    <p className="text-[10px] font-black text-white/40 uppercase tracking-widest">Global Reach</p>
                                    <p className="text-sm font-bold text-white uppercase">Serving Worldwide</p>
                                </div>
                            </motion.div>
                        </aside>
                        ...
                        <div className="lg:col-span-8 space-y-24">
                            ...
                            {/* Dynamic Rich Text Content from AdminJS */}
                            <motion.div
                                initial="hidden"
                                whileInView="visible"
                                viewport={{ once: true, margin: "-100px" }}
                                variants={containerVariants}
                                className="prose prose-invert prose-dr max-w-none prose-headings:font-black prose-headings:tracking-tighter prose-headings:uppercase prose-h2:text-3xl prose-h2:text-white prose-h2:mt-16 prose-h2:mb-8 prose-h3:text-dr-gold prose-p:text-dr-text/80 prose-p:leading-relaxed prose-a:text-dr-gold prose-a:no-underline hover:prose-a:underline prose-strong:text-white prose-ul:text-dr-text/80 prose-img:rounded-3xl prose-img:border prose-img:border-white/10"
                            >
                                    ...
                                    <div className="flex flex-col md:flex-row items-center justify-between gap-10 relative z-10">
                                        <div className="text-center md:text-left space-y-4 max-w-md">
                                            ...
                                            <p className="text-sm text-white/40 font-medium">
                                                Schedule your priority audit and secure your position today.
                                            </p>
                                        </div>
